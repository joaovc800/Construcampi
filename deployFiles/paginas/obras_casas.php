...
<head>
	<title>Casas Pre-fabricadas - Construcampi</title>
	<meta charset="utf-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
	<link rel="stylesheet" href="../public/assets/css/obras.css" />
	<?php include "../includes/css_imports.php"; ?>
	<meta name="keywords" content="contrucampi,Construcampi,CONSTRUCAMPI,arquitetura,casas,pré-fabricadas,engenharia">
			...
			<div class="container-fluid adjust">
				<div class="row ml-5 ">
					<div class="col-12 col-12-narrow overflow_right">
						...
						<!-- row 3 items com animação da direita a origen sem texto -->
						...
						<!-- row 3 items com animação da esquerda a origen sem texto -->
