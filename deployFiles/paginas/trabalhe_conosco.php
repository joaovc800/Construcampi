...
<html lang="pt-br">
	<head>
		<title>Trabalhe Conosco - Construcampi</title>
		<meta charset="utf-8" />
							...
							<section class="text-start d-flex justify-content-center mb-4">
								<div class="email_instrucoes">
									...
									<ul class="px-5 py-2">
										...
										<li>Coloque seu <span class="text-danger">nome</span> e <span class="text-danger">telefone de contato</span> no corpo do email</li>
										<li>Anexe seu currículo mais atualizado</li>
									</ul>
								</div>
							</section>
							<section class="text-center py-5 d-flex justify-content-center card_email">
