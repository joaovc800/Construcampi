		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<div class="box">
						<p>A sua privacidade é importante para nós. É política do ContruCampi respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=contru.com.br>ContruCampi</a>, e outros sites que possuímos e operamos.</p> 
						...
						<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o ContruCampi oferece no site e com caráter enunciativo, mas não limitativo:</p> 
							<ul> 
								...
								<li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do ContruCampi, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li> 
							</ul> 
