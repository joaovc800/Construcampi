			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<div class="box">
						...
						<h2 class="pt-4">POLÍTICA DE COOKIES CONSTRUCAMPI</h2> 
						...
						<ul> 
							<li> Cookies relacionados à conta <br> Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair do sistema, porém, em alguns casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao sair.<br><br> </li> 
							...
							<li> Cookies relacionados a boletins por e-mail <br> Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas para usuários inscritos / não inscritos.<br><br> </li> 
							...
							<li> Cookies relacionados a formulários <br> Quando você envia dados por meio de um formulário como os encontrados nas páginas de contacto ou nos formulários de comentários, os cookies podem ser configurados para lembrar os detalhes do usuário para correspondência futura.<br><br> </li> 
						...
						<div class="numeral"> 
							...
							<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que a Construcampi oferece no site e com caráter enunciativo, mas não limitativo:</p> 
								<ul> 
									...
									<li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) da Construcampi, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li> 
								</ul> 
							<h3>Mais informações</h3> 
							<p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p> 
							<p>Esta política é efetiva a partir de <strong>Abril</strong>/<strong>2022</strong>.</p>
						</div>
					</div>
				</section>
